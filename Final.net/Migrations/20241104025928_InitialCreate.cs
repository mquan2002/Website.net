    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "ADMIN", new DateTime(2024, 11, 4, 9, 59, 27, 578, DateTimeKind.Local).AddTicks(6171), false, "Admin", null },
                    { 2, "USER", new DateTime(2024, 11, 4, 9, 59, 27, 578, DateTimeKind.Local).AddTicks(6182), false, "User", null }
                });
